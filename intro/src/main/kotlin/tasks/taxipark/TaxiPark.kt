...
/** The TaxiPark class stores information about registered drivers, passengers, and their trips.
 * The task is to implement six functions which collect different statistics about the data.
 */
data class TaxiPark(
